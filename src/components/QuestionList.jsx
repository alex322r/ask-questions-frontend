  ...
  return (
          <div className="w-auto mb-5   border-t-[0.1px] border-solid border-amber-50 ">
            ...
            questions.map((question) => (
                <Question key={question.id} id={question.id} title={question.title} description={question.description} author={question.author} createdDate={question.createdAt} views={question.views} />
              ))
            }
          </div>
